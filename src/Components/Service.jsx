      ...
      <PhotoProvider>
        <div className="flex flex-col mb-6 lg:justify-between lg:flex-row md:mb-8">
          ...
          <p className="text-gray-700 font-semibold text-justify lg:text-md lg:max-w-md">
            I have received a Master of Arts in Photography and take immense
            pride in being renowned as one of the most experienced. and trusted
            wedding photographers working in Sydney today. We have more than 100
            five stars google reviews and countless kind words from our
